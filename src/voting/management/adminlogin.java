...
public class adminlogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jvoterpassword.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jvlogin.setBackground(new java.awt.Color(255, 255, 0));
        ...
        jvreset.setBackground(new java.awt.Color(255, 255, 0));
    ...
    private void jloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jloginActionPerformed
        try {
            ...
            Connection  con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/voting management system", 
                    "postgres", "postgres");
            String sql="select*from adm where name=? and password=?";
    ...
    private void jvloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jvloginActionPerformed
         ...
         try {
            ...
            if(result.next()){
                JOptionPane.showMessageDialog(null, "Credentials verified and OTP sent.");
